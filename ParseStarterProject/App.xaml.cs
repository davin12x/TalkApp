    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame == null)
            {
               ...
               /* var TESTINGBAGGA = new ParseObject("TestObject");
                TESTINGBAGGA["bagga"] = "hello i m there";
                await TESTINGBAGGA.SaveAsync();
                //reteriving

                ParseQuery<ParseObject> query = ParseObject.GetQuery("TestObject");
                ParseObject testObject = await query.GetAsync("n3YN7YHMpa");
